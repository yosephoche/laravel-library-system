    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h2 class="panel-title">Export Semua Data Peminjaman</h2>
        </div>

        <div class="panel-body">
          {!! Form::open(['url' => route('export.borrow.post'),
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h2 class="panel-title">Export Data Peminjaman Berdasarkan Tanggal</h2>
        </div>
        
        <div class="panel-body">
          {!! Form::open(['url' => route('export.borrow.post.date'),
          'method' => 'post', 'class'=>'form-horizontal']) !!}
